...
model_dir = "prediction_service/model/model_rf.pkl"
model = joblib.load(model_dir)


with st.sidebar:
    st.title('Cosignment Pricing Prediction Application')
    options = add_radio = st.radio(
    ...
    st.markdown("""
    ## About
    Your ultimate tool for accurately estimating the value of consigned items with unprecedented precision and ease. 
    Whether you're a consignor looking to set the perfect price or a potential buyer seeking to make an informed decision, 
    our platform empowers you with data-driven insights that take the guesswork out of the equation.
